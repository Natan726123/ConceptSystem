...
begin
  ...
  try
    ...
    DSDadosItensLista.DataSet.FieldByName('Item').AsInteger := GetNextIdItemLista(numOrdemAtivo); // Próximo ID da lista
...
begin
  ...
  begin
    RefProduto := Trim(edtCodProd.Text); // Captura e limpa o texto digitado no TEdit
