object FormFichaFaccao: TFormFichaFaccao
  Left = 0
  Top = 0
  ...
  object lblNumFaccao: TLabel
    Left = 8
    Top = 95
    Width = 131
    Height = 24
    Caption = 'N'#176' FAC'#199#195'O: '
    Enabled = False
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -20
  ...
  object pnlModelos: TPanel
    ...
    object lblNumTotalPecas: TLabel
      Left = 798
      Top = 9
      Width = 145
      Height = 24
      Caption = 'N'#176' de pe'#231'as: '
      Enabled = False
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -20
    ...
    object btnAdicionarItens: TButton
      ...
      ParentFont = False
      TabOrder = 4
      OnClick = btnAdicionarItensClick
    end
    ...
    object ComboBoxCores: TComboBox
      Left = 266
      Top = 112
      Width = 166
      Height = 25
    ...
    object ComboBoxCortador: TComboBox
      ...
      TabOrder = 15
      TextHint = 'Selecione o modelo'
      OnChange = ComboBoxCortadorChange
    end
  ...
  object DBGridFichaDeFaccao: TDBGrid
    ...
    BorderStyle = bsNone
    Color = clSnow
    DataSource = DSDadosFichaDeFaccao
